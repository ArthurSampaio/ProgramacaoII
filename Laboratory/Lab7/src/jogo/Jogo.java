...
public abstract class Jogo {
	...
	public void addJogabilidades(Set<Jogabilidade> jogabilidade){
		for(Jogabilidade jogabilidades : jogabilidade ){
			this.jogabilidades.add(jogabilidades);
		}
	}

	public Set<Jogabilidade> getJogalidade(){
